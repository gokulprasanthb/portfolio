        ...
        <div className='w-auto pt-10'>
            <div className='flex flex-col md:flex-row md:px-28 md:space-x-14  max-md:flex-wrap items-center justify-center max-md:gap-6 max-md:pl-2 max-md:space-y-8'>
                <motion.div initial={{opacity:0, x:-100}} whileInView={{opacity:1, x:0}} transition={{duration:0.5, delay:0.5}} className='w-1/3 max-md:w-80 space-y-2 bg-white shadow-md rounded-sm pb-10 pr-0 hover:bg-slate-200 hover:shadow-xl duration-700'>
                    ...
                    <a target='_blank' href='https://github.com/gokulprasanthb/groceze' className='px-10 py-3 md:ml-32 ml-24 border-2 text-white bg-indigo-500  rounded-3xl hover:bg-indigo-600 hover:text-white hover:border-indigo-600 duration-300'>Visit</a>
                </motion.div>
                <motion.div initial={{opacity:0, x:-100}} whileInView={{opacity:1, x:0}} transition={{duration:0.5, delay:0.5}} className='w-1/3 max-md:w-80 space-y-2 bg-white shadow-md rounded-sm pb-10 pr-0 hover:bg-slate-200 hover:shadow-xl duration-700'>
                    ...
                    <a target='_blank' href='https://github.com/gokulprasanthb/musify' className='px-10 py-3 md:ml-32 ml-24 border-2 text-white bg-indigo-500  rounded-3xl hover:bg-indigo-600 hover:text-white hover:border-indigo-600 duration-300'>Visit</a>
                </motion.div>
                <motion.div initial={{opacity:0, x:-100}} whileInView={{opacity:1, x:0}} transition={{duration:0.5, delay:0.5}} className='w-1/3 max-md:w-80 space-y-2 bg-white shadow-md rounded-sm pb-10 pr-0 hover:bg-slate-200 hover:shadow-xl duration-700'>
                    ...
                    <a target='_blank' href='https://github.com/gokulprasanthb/react_nike_landingPage' className='px-10 py-3 md:ml-32 ml-24 border-2 text-white bg-indigo-500  rounded-3xl hover:bg-indigo-600 hover:text-white hover:border-indigo-600 duration-300'>Visit</a>
                </motion.div>
            </div>
        </div >
    </section>
