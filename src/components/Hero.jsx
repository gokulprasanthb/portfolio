    ...
    <section className='flex flex-row justify-center md:pl-52  md:py-20 md:pt-48 max-md:flex-col max-md:px-3 max-md:pt-28 max-md:pl-10 max-md:space-y-7 w-screen mx-0'>
        <div className='w-1/2 mt-2 text-5xl space-y-5 text-indigo-950 max-md:w-full max-md:text-3xl max-md:text-center max-md:mt-16'>
            ...
            <div className='text-xl md:space-x-6 pt-2 max-md:flex max-md:flex-col max-md:items-center max-md:space-y-8'>
                <button className='duration-300 border-2 text-white bg-indigo-500 w-36 h-14 hover:bg-indigo-600 hover:text-white hover:border-indigo-600 rounded-sm max-md:ml-1'>Download CV</button>
                <button className='duration-300 max-md:hidden border-2 text-white bg-indigo-500 w-36 h-14 hover:bg-indigo-600 hover:text-white hover:border-indigo-600 rounded-sm max-md:ml-1'>Connect</button>
            </div>
