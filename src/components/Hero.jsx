...
const Hero = () => {
  return (
    <section className='flex flex-row justify-center pl-40 px-28 pt-32  max-md:flex-col max-md:px-5 max-md:pt-5'>
        <div className='w-1/2 mt-24 text-5xl space-y-5 text-indigo-900 max-md:w-full max-md:text-3xl max-md:text-center'>
            <h1>Hi, </h1>
        ...
        <div className='w-1/2 pl-14 max-md:w-full max-md:pl-0'>
            <img src={image} alt="" className='h-96 rounded-lg max-md:pl-6 max-md:pt-10' />
        </div>
    </section>
  )
}
